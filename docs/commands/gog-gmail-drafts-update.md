...
| `--clear-reply-context` | `bool` |  | Strip In-Reply-To/References from the draft, making it standalone. By default an update validates stored reply headers and repairs stale context from the Gmail thread. |
